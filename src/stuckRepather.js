...
Usage:
    ...
    creep.travelTo() will then automatically repath to avoid getting stuck when using a high "reusePath" value or "ignoreCreeps: true"
*/

const travelTo = Creep.prototype.travelTo;
Creep.prototype.travelTo = function(firstArg, secondArg, opts)
{
    ...
    const result = travelTo.call(this, firstArg, secondArg, opts);
...
function pathAroundCreepsIfStuck(creep, secondArg, opts)
{
    ...
    // Don't worry about this. Essentially either of these may be the true opts-object due to how travelTo works internally
